...
MERGE = lambda a: lambda b: IF_THEN_ELIF_THEN_ELSE(IS_EMPTY(a))(b)(IS_EMPTY(b))(a)(IF_THEN_ELSE(LT(HEAD(a))(HEAD(b)))(INSERT_FRONT(MERGE(TAIL(a))(b))(HEAD(a)))(INSERT_FRONT(MERGE(a)(TAIL(b)))(HEAD(b))))
